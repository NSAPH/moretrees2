...
for (i in 1:length(dataset)) { # datasets
   ...
   load(file = paste0("./results/mod", mod, "_split0_", ds, "_sens4.Rdata"))
   mod0 <- moretrees_results
   load(file = paste0("./results/mod", mod, "_split25_", ds, "_sens4.Rdata"))
   ...
   tabfile <- paste0("./figures/mod", mod, "_", ds, "_table_sens4.tex")
