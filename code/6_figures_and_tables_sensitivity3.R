...
for (i in 1:length(dataset)) { # datasets
   ...
   for (mod in 3:nmods) { # models
      ...
      load(file = paste0("./results/mod", mod, "_split0_", ds, "_sens3.Rdata"))
      mod0 <- moretrees_results
      load(file = paste0("./results/mod", mod, "_split25_", ds, "_sens3.Rdata"))
      ...
      tabfile <- paste0("./figures/mod", mod, "_", ds, "_table_sens3.tex")
