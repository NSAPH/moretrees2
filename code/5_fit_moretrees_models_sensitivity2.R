...
# save
save(moretrees_results, file = paste0("./results/mod1_split", split, "_", dataset, "_sens2.RData"))
...
# save
save(moretrees_results, sd_tmmx, sd_rmax, file = paste0("./results/mod2_split", split, "_", dataset, "_sens2.RData"))
...
# save
save(moretrees_results, sd_tmmx, sd_rmax, file = paste0("./results/mod3_split", split, "_", dataset, "_sens2.RData"))
