...
# save
save(moretrees_results, file = "./results/mod1_split0_northEast_cvd.RData")
...
# save
save(moretrees_results, sd_tmmx, sd_rmax, file = "./results/mod2_split0_northEast_cvd.RData")
...
# save
save(moretrees_results, sd_tmmx, sd_rmax, file = "./results/mod3_split0_northEast_cvd.RData")
