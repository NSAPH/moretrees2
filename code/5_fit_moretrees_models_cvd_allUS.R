...
# save
save(moretrees_results, file = "./results/mod1_split35_all_cvd.RData")
...
# save
save(moretrees_results, sd_tmmx, sd_rmax, file = "./results/mod2_split35_all_cvd.RData")
...
# save
save(moretrees_results, sd_tmmx, sd_rmax, file = "./results/mod3_split35_all_cvd.RData")
